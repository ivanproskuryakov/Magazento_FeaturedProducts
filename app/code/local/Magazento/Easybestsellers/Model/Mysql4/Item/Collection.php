...
class Magazento_Easybestsellers_Model_Mysql4_Item_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {

    protected function _construct() {
        $this->_init('easybestsellers/item');
    }
    ...
    public function addStoreFilter($store, $withAdmin = true) {
        ...
        $this->getSelect()->join(
                        array('item_store' => $this->getTable('easybestsellers/item_store')),
    ...
    public function addCategoryFilter($category) {
        ...
        $this->getSelect()->joinleft(
                        array('item_category' => $this->getTable('easybestsellers/item_category')),
    ...
    public function addProductFilter($product) {
        ...
        $this->getSelect()->joinleft(
                        array('item_product' => $this->getTable('easybestsellers/item_product')),
    ...
    public function addPageFilter($page) {
        $this->getSelect()->joinleft(
                    array('item_page' => $this->getTable('easybestsellers/item_page')),
