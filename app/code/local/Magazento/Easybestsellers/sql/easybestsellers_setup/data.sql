...
--
-- Host: localhost
-- Generation Time: Dec 06, 2012 at 11:24 AM
...
--
-- Table structure for table `magazento_easybestsellers_item`
--

CREATE TABLE IF NOT EXISTS `magazento_easybestsellers_item` (
...
--
-- Dumping data for table `magazento_easybestsellers_item`
--

INSERT INTO `magazento_easybestsellers_item` (`item_id`, `count`, `colcount`, `order`, `layout`, `assign_categories`, `assign_pages`, `assign_products`, `title`, `url`, `position`, `from_time`, `to_time`, `is_active`, `content_top`, `content_bottom`, `bestseller_type`, `on_checkout`, `css`, `bestsellercategory`, `display_type`) VALUES
...
--
-- Table structure for table `magazento_easybestsellers_item_assignedproduct`
--

CREATE TABLE IF NOT EXISTS `magazento_easybestsellers_item_assignedproduct` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `assignedproduct_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_easybestsellers_item_assignedproduct`
--

INSERT INTO `magazento_easybestsellers_item_assignedproduct` (`item_id`, `assignedproduct_id`) VALUES
(50, 162),
(50, 163),
(50, 164),
(50, 165),
...
--
-- Table structure for table `magazento_easybestsellers_item_category`
--

CREATE TABLE IF NOT EXISTS `magazento_easybestsellers_item_category` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `category_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_easybestsellers_item_category`
--

INSERT INTO `magazento_easybestsellers_item_category` (`item_id`, `category_id`) VALUES
(53, 10),
(53, 13),
(53, 18);
...
--
-- Table structure for table `magazento_easybestsellers_item_page`
--

CREATE TABLE IF NOT EXISTS `magazento_easybestsellers_item_page` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `page_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_easybestsellers_item_page`
--

INSERT INTO `magazento_easybestsellers_item_page` (`item_id`, `page_id`) VALUES
(49, 3),
(50, 3),
(51, 3),
(52, 3),
...
--
-- Table structure for table `magazento_easybestsellers_item_product`
--

CREATE TABLE IF NOT EXISTS `magazento_easybestsellers_item_product` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `product_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_easybestsellers_item_product`
--
...
--
-- Table structure for table `magazento_easybestsellers_item_review`
--

CREATE TABLE IF NOT EXISTS `magazento_easybestsellers_item_review` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `review_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_easybestsellers_item_review`
--

INSERT INTO `magazento_easybestsellers_item_review` (`item_id`, `review_id`) VALUES
(NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `magazento_easybestsellers_item_store`
--

CREATE TABLE IF NOT EXISTS `magazento_easybestsellers_item_store` (
  `item_id` smallint(6) unsigned DEFAULT NULL,
  `store_id` smallint(6) unsigned DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `magazento_easybestsellers_item_store`
--

INSERT INTO `magazento_easybestsellers_item_store` (`item_id`, `store_id`) VALUES
(49, 0),
(50, 0),
(51, 0),
(52, 0),
